...
"""
Types for PyCalistaIsta.

This module defines various TypedDicts used in the PyCalistaIsta client to represent
responses and data structures from the ista Calista API.

See Also
--------
PyCalistaIsta : The main client class for interacting with the ista Calista API.
"""
...
class AccountResponse(TypedDict):  # numpydoc ignore=ES01,SA01,EX01
    """
    Represents the response for an account in the ista Calista API.
